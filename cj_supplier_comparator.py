...
# ---------------------------
# CJ API Order Fetch (Seller v1 version)
...
st.title("CJ API - Finally Working Order Fetch ✅")
...
start_date = st.date_input("Start date", default_start_date).strftime('%Y-%m-%d 00:00:00')
end_date = st.date_input("End date", default_end_date).strftime('%Y-%m-%d 23:59:59')
